...
import com.example.android.animallog.data.PetDbHelper;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    /** EditText field to enter the pet's type */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTypeEditText = (EditText) findViewById(R.id.edit_pet_type);
    ...
    private void savePet()
    {
        ...
        values.put(PetEntry.COLUMN_PET_TYPE, typeString);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int typeColumnIndex = cursor.getColumnIndex(PetEntry.COLUMN_PET_TYPE);
